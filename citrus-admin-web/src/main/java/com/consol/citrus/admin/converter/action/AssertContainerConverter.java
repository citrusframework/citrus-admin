 ...
 */
@Component
public class AssertContainerConverter extends AbstractTestContainerConverter<AssertModel, Assert> {

    public AssertContainerConverter() {
        super("assert");
    }
    ...
    @Override
    public AssertModel convertModel(Assert model) {
        AssertModel action = new ObjectFactory().createAssertModel();
    ...
    private void setNestedAction(AssertModel action, Object object) {
        ...
        } else if (object instanceof ReceiveModel) {
            action.getWhen().setReceive((ReceiveModel) object);
        ...
        } else if (object instanceof SendModel) {
            action.getWhen().setSend((SendModel) object);
    ...
    @Override
    public Class<Assert> getActionModelClass() {
        return Assert.class;
    }
