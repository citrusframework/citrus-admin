 ...
 */
@Component
public class HttpServerConverter extends AbstractEndpointConverter<HttpServerModel> {
    ...
    @Override
    public Class<HttpServerModel> getSourceModelClass() {
        return HttpServerModel.class;
    }
