...
[source,bash]
----
java -Dcitrus.admin.project.home=/Users/myaccount/path/tp/citrus/project/home -jar citrus-admin-web-1.0.2-SNAPSHOT.war
----
...
-Dcitrus.admin.xml.source.directory=src/it/resources -jar citrus-admin-web-1.0.2-SNAPSHOT.war
----
...
[source,bash]
----
java -Dserver.port=8181 -jar citrus-admin-web-1.0.2-SNAPSHOT.war
----
