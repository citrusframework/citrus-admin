...
The second approach for creating new projects is to generate the project sources from a Maven archetype. Citrus provides several archetypes on Maven central (link:https://search.maven.org/#search%7Cga%7C1%7Cg%3A%22com.consol.citrus.archetypes%22[search.maven.org]). Just
...
[source,bash]
----
java -Dcitrus.admin.project.home=/Users/myaccount/path/tp/citrus/project/home -jar citrus-admin-web-1.0.3.war
----
...
-Dcitrus.admin.xml.source.directory=src/it/resources -jar citrus-admin-web-1.0.3.war
----
...
[source,bash]
----
java -Dserver.port=8181 -jar citrus-admin-web-1.0.3.war
----
