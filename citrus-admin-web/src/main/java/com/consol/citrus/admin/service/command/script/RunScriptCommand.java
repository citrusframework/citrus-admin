...
package com.consol.citrus.admin.service.command.script;
 ...
 */
public class RunScriptCommand extends AbstractTerminalCommand {

    /** Logger */
    private static Logger log = LoggerFactory.getLogger(RunScriptCommand.class);

    private static final String RUN = ". %s";
     ...
     */
    public RunScriptCommand(File workingDirectory, ProcessListener... shellListeners) {
    ...
    public String buildCommand() {
        ...
        builder.append(String.format(RUN, script));

        log.debug("Using run command: " + builder.toString());
     ...
     * @return
     */
    public RunScriptCommand script(String script) {
        this.script = script;
        return this;
    }
}
