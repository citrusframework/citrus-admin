 ...
 */
@Component
public class SendResponseActionConverter extends AbstractTestActionConverter<SendResponseModel, SendMessageAction> {
    ...
    protected <V> V resolvePropertyExpression(V value) {
        if (value instanceof SendResponseModel.Body) {
            SendResponseModel.Body body = (SendResponseModel.Body) value;
    ...
    @Override
    public SendResponseModel convertModel(SendMessageAction model) {
        SendResponseModel action = new ObjectFactory().createSendResponseModel();
    ...
    @Override
    public Class<SendResponseModel> getSourceModelClass() {
        return SendResponseModel.class;
    }
